...
class LoadDatabase {
    ...
    @Bean
    CommandLineRunner initDatabase(DrinkRepository drinkRepository, OrderRepository orderRepository, FavoriteRepository favoriteRepository) {
        return args -> {
            ...
            favoriteRepository.save(new Favorite(drink1));
            favoriteRepository.save(new Favorite(drink5));
            favoriteRepository.save(new Favorite(drink2));
