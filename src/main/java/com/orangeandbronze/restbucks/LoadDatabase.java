...
class LoadDatabase {
    ...
    CommandLineRunner initDatabase(DrinkRepository drinkRepository, OrderRepository orderRepository, FavoriteRepository favoriteRepository, ProfileRepository profileRepository) {
        return args -> {
            ...
            Drink drink5 = new Drink("Chai Tea Latte", "A concentrated blend of full-bodied black teas, black pepper and spicy ginger with notes of cardamom and vanilla, lightly sweetened. Topped with hot water, steamed milk and foam.", "P235.00", "https://d1ralsognjng37.cloudfront.net/c49d796e-07ea-46bd-8bd8-b496a8851e38.jpeg");
